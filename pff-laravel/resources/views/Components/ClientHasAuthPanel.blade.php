                ...
                <table class="min-w-full bg-white">
                    ...
                    <tbody>
                        @foreach ($orders as $order)
                            <tr>
                                <td class="py-2 px-3 border">{{ $order->order_number }}</td>
                                <td class="py-2 px-3 border">{{ $order->pickUpLocation }}</td>
                                <td class="py-2 px-3 border">{{ $order->pickUpTime }}</td>
                                <td class="py-2 px-3 border">{{ $order->dropOffLocation }}</td>
                                <td class="py-2 px-3 border">{{ $order->dropOffTime }}</td>
                                <td class="py-2 px-3 border">{{ $order->status }}</td>
