<div>
    ...
    <nav>
        {{-- <ul class="sidebar">
            ...
            <li><a href="/">Home</a></li>
            <li><a href="/client/orders">Order</a></li>
            ...
            <li><a href="{{ route('client.index') }}" class='logo'>
                    <svg id="logo-87" width="202" height="40" viewBox="0 0 202 40" fill="none"
                        ...
                        <path class="ccustom" fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            fill="#007DFC"></path>
                        <path class="ccustom" d="M125.619 14.4525H120.767V29.8648H125.619V14.4525Z" fill="#007DFC">
                        </path>
                        <path class="ccustom"
                            ...
                            fill="#007DFC"></path>
                        <path class="ccustom" d="M51.1562 29.8648V7.47568H56.1351V25.4885H66.0612V29.8648H51.1562Z"
                            fill="#007DFC"></path>
                        <path class="ccustom" fill-rule="evenodd" clip-rule="evenodd"
